...
Generate and upload the support bundle described [here](/flow/devs/support/support_bundle)

`>  Provide authentication token`

Authenticate using your token without browser redirection. See[ Login issues with browser redirection ](/flow/devs/support/common_problems)
...
Allow you to change the scope of issues as defined [here](/flow/devs/discover_extension/treeview)
