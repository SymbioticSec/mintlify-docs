...
![Extension Treeview](/flow/devs/images/treeview_withscopes.png)
...
### Scopes
To see only issues relevant on your context, you can change the scope of the treeview by either : 
- Clicking on the scope at the top of the treeview 
