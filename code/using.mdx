...
[Learn more about skills](/code/configurations/skills)
...
[Full MCP documentation](/code/configurations/mcp)
...
[Full plugin documentation](/code/configurations/plugins)
...
<Columns cols={3}>
  ...
  <Card title="MCP Servers" icon="plug" href="/code/configurations/mcp">
    Full reference for local and remote MCP configuration.
  </Card>
  <Card title="Skills" icon="graduation-cap" href="/code/configurations/skills">
    Write and distribute reusable agent instruction sets.
  </Card>
  <Card title="Plugins" icon="puzzle" href="/code/configurations/plugins">
