...
```ts title=".symbiotic/tools/database.ts" {1}
...
```ts title=".symbiotic/tools/math.ts"
import { tool } from "@opencode-ai/plugin"
...
```ts title=".symbiotic/tools/bash.ts"
import { tool } from "@opencode-ai/plugin"
...
```ts title=".symbiotic/tools/project.ts" {8}
import { tool } from "@opencode-ai/plugin"
...
```python title=".symbiotic/tools/add.py"
import sys
...
```ts title=".symbiotic/tools/python-add.ts" {10}
import { tool } from "@opencode-ai/plugin"
