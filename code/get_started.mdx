...
By default, Symbiotic Code will ask you your permission before editing any file but you can configure it to automatically accept changes by switching to the `Accept edits` mode using SHIFT + TAB
...
|I cant' go to the next line | Try one of those keybindings `shift+return`, `ctrl+return`, `alt+return`, `ctrl+j` |