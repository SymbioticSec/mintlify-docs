---
title: "ACP"
description: "Use Symbiotic Code in editors and IDEs"
---
...
To use Symbiotic Code as an ACP agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), add the following to your Neovim config:
...
This config sets up CodeCompanion to use Symbiotic Code as the ACP agent for chat.
