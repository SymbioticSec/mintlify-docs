...
Our chat and remediation features share the same customer context — the portion of code that needs to be corrected (for example, a Terraform resource). In addition, **Symbiotic’s flow** is added to describe the detected vulnerability, examples of secure code, remediation advice, or the remediation snippet already generated for the chat feature.
