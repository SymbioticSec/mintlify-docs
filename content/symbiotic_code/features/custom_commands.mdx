...
description: "Custom commands let you define reusable prompts that run when you type `/command-name` in the TUI. They support dynamic content via arguments, shell output, and file references."
---
