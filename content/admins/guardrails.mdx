...
<Info>
If you have the extension installed, guardrails will be automatically added to your repository when you open it in the IDE.
This ensures that all developers working on the repository have access to the same security context.
