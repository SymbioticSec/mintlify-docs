...
<Tip>
  Don't forget to retrieve you organization token and to set it as a secret in your Github setttings.
</Tip>
...
<Steps>
  <Step title="Install our CLI" titleSize="p">
    ```bash
    |
          curl -sSL https://github.com/SymbioticSec/cli/releases/download/v0.11.0-beta1/install.sh | bash
